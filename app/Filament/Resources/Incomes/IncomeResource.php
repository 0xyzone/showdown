...
class IncomeResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Income Tracking';

    protected static ?string $modelLabel = 'Income Record';

    protected static ?string $pluralModelLabel = 'Income Records';

    protected static ?string $breadcrumb = 'Income Tracking';
