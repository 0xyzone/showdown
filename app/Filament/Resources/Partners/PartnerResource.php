...
class PartnerResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Official Partners';

    protected static ?string $modelLabel = 'Official Partner';

    protected static ?string $pluralModelLabel = 'Official Partners';
